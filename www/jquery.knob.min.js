    ...
    t.Dial = function() {
        ...
        this.arc = function(e) {
            ...
            if (this.o.flip) {
				...
				if(e < 0) {
					t = 1.5 * Math.PI - this.startAngle + ea;
					n = 1.5 * Math.PI;					
				} else {
					t = 1.5 * Math.PI; 
					n = this.startAngle + ea;				
				}
				//console.log("ea = " + ea + " - t = " + t + " - n = ", n)
        ...
        this.draw = function() {
			...
			//console.log("cv = " + this.cv + " - t.s = " + t.s + " - t.e = ", t.e)
			e.strokeStyle = this.cv > 0 ? '#ff0000' : '#00ff00';
